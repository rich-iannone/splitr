...
#'   filtering those trajectory endpoints files generated by SplitR using the
#'   \code{hysplit_trajectory} function since such files have a specified naming
#'   convention.
#' @param start_height_m_AGL providing a starting height will filter the list of
#'   trajectory endpoints files to be read into a data frame. This argument can
#'   be used in conjunction with the \code{year} argument in order to filter a
#'   directory of endpoints files by year and by starting height. As with the
#'   \code{year} argument, this option is usually only effective for filtering
#'   those trajectory endpoints files generated by SplitR.
#' @return a data frame with several wind trajectory parameters
#' @examples
#' \dontrun{
