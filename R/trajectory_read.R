...
#' @description The function takes HYSPLIT trajectory output files in a
#' specified output directory and processes all files into a data frame object.
#' @param archive_folder the absolute path and filename of the trajectory
#' archive file (UNIX) or folder (Windows) is to be provided.
#' @param year providing a year will filter the list of trajectory endpoints
#' files to be read into a data frame. This is usually only effective for
#' filtering those trajectory endpoints files generated by SplitR using
#' the \code{hysplit_trajectory} function since such files have a specified naming
#' convention.
#' @param start_height_m_AGL providing a starting height will filter the list
#' of trajectory endpoints files to be read into a data frame. This argument
#' can be used in conjunction with the \code{year} argument in order to filter a
#' directory of endpoints files by year and by starting height. As with the
#' \code{year} argument, this option is usually only effective for filtering those
#' trajectory endpoints files generated by SplitR.
