...
#'   `hysplit_trajectory` function since such files have a specified naming
#'   convention.
...
#'   be used in conjunction with the `year` argument in order to filter a
#'   directory of endpoints files by year and by starting height. As with the
#'   `year` argument, this option is usually only effective for filtering
