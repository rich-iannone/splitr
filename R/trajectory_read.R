...
#' @param archive_folder the absolute path and filename of the trajectory archive file (UNIX) or folder (Windows) is to be provided.
#' @param year providing a year will filter the list of trajectory endpoints files to be read into a data frame. This is usually only effective for filtering those trajectory endpoints files generated by SplitR using the the 'hysplit_trajectory' function since such files have a specified naming convention.
...
#' trajectory.df <- trajectory_read(archive_folder =
