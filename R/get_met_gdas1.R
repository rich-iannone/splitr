...
#' specifying a list of filenames (in the form of "RP[YYYY][MM].gbl") or through
#' bulk download of a year of files.
#' @param files a vector list of exact filenames for the GDAS1 files.
#' @param years a vector list of years for which GDAS1 files are to be obtained
#'   via FTP.
#' @param months a vector list of months for which GDAS1 files are to be
#'   obtained via FTP.
...
get_met_gdas1 <- function(files = NULL,
  ...
  gdas1_dir <- "ftp://arlftp.arlhq.noaa.gov/archives/gdas1.v1/"
