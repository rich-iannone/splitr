#' Get list of presets
#' @description This function allows you to generate a
#' simple list of presets of a given type. If no type
#' is provided, the user is prompted to enter a type.
#' The list is presented as a series of oneline
#' summaries that are numbered in the order they
#' appear in their respective files. This numbering is
#' important, as the 'hysplit_dispersion' function
#' calls presets by these numbers. It is possible to
#' search for a preset of a certain type by its name
#' through use of the 'search' argument. If there is
#' an exact match by name, then the number associated
#' with that preset is returned.
...
#' @param search a search term corresponding to the
#' name of a preset of the type provided within the
