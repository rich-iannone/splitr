...
docker run -p 8787:8787 -e ROOT=true -e DISABLE_AUTH=true -v $(pwd):/home/rstudio/kitematic/ splitr -it /bin/bash
```
...
(cd \"/home/rstudio/kitematic\" && \"/usr/local/lib/R/site-library/splitr/linux-amd64/hyts_std\" >> /dev/null 2>&1)"
```
## HYSPLIT Citations
