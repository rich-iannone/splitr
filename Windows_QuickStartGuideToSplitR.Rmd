...
trajectory.df <- 
  hysplit.trajectory(traj_name = "third",
                     ...
                     path_met_files = paste(Sys.getenv()["HOME"], "\\Hysplit\\Met\\", sep = ''),
                     path_output_files = paste(Sys.getenv()["HOME"], "\\Hysplit\\Output\\", sep = ''),
                     path_wd = paste(Sys.getenv()["HOME"], "\\Hysplit\\Working\\", sep = ''),
                     path_executable = paste(Sys.getenv()["HOME"], "\\Hysplit\\Exec\\", sep = ''))
```
...
```{r, eval = FALSE}
hysplit.dispersion.config(path_wd = paste(Sys.getenv()["HOME"], "\\Hysplit\\Working\\", sep = ''))
```
...
```{r, eval = FALSE}
dispersion.preset.list(path_wd = paste(Sys.getenv()["HOME"], "\\Hysplit\\Working\\", sep = ''))
```
...
```{r, eval = FALSE}
dispersion.preset.delete(path_wd = paste(Sys.getenv()["HOME"], "\\Hysplit\\Working\\", sep = ''))
```
