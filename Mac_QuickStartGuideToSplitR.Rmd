...
trajectory.df <- 
  hysplit.trajectory(traj_name = "third",
                     ...
                     path_met_files = "~/Documents/Hysplit/Met/",
                     path_output_files = "~/Documents/Hysplit/Output/",
                     path_wd = "~/Documents/Hysplit/Working/",
                     path_executable ="~/Documents/Hysplit/Exec/")
```
...
```{r, eval = FALSE}
hysplit.dispersion.config(path_wd = "~/Documents/Hysplit/Working/")
```
...
```{r, eval = FALSE}
dispersion.preset.list(path_wd = "~/Documents/Hysplit/Working/")
```
...
```{r, eval = FALSE}
dispersion.preset.delete(path_wd = "~/Documents/Hysplit/Working/")
```
