...
```{r, eval = FALSE}
hysplit.dispersion.config(path_wd = "~/Documents/SplitR/Working/")
```
...
```{r, eval = FALSE}
dispersion.preset.list(path_wd = "~/Documents/SplitR/Working/")
```
...
```{r, eval = FALSE}
dispersion.preset.delete(path_wd = "~/Documents/SplitR/Working/")
```
